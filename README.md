# Module Project: Component Lifecycle Methods - React Github User API Card
...
- [ ] Copy the URL and paste it into your daily reflection form.
...
- [ ] Submit a Pull-Request to merge <firstName-lastName> Branch into `main` (student's Repository). **Please don't merge your own pull request**
- [ ] From the home page of your repo, make sure you have your branch selected
- [ ] Copy the URL and paste it into your daily reflection form to submit your project
